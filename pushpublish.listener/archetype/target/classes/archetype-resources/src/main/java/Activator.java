...
import ${package}.listener.AddToQueueSubscriber;
import ${package}.listener.PushPublishEndSubscriber;
import ${package}.listener.PushPublishStartSubscriber;
import ${package}.listener.SuccessEndpointsSubscriber;
import ${groupId}.system.event.local.business.LocalSystemEventsAPI;
...
public class Activator extends GenericBundleActivator {
    ...
    public void stop(BundleContext bundleContext) throws Exception {
        ...
        localSystemEventsAPI
            .unsubscribe(PushPublishStartEvent.class, PushPublishStartSubscriber.class.getName() + "${symbol_pound}notify");

        localSystemEventsAPI
            .unsubscribe(PushPublishEndEvent.class, PushPublishEndSubscriber.class.getName() + "${symbol_pound}notify");
